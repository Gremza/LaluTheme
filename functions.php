...
function lalutheme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'large Image Replace', // The plugin name.
			'slug'               => 'large-image-replace-main', // The plugin slug (typically the folder name).
			'source'             => 'https://github.com/Gremza/large-image-replace/archive/refs/heads/main.zip', // The plugin source.
			'required'           => false, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '10.6.9', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		...
		array(
			...
			'slug'               => 'sicialmetagremza', // The plugin slug (typically the folder name).
