...
<?php if (get_theme_mod( 'gr_favicon' )) : echo get_theme_mod( 'gr_favicon'); else: echo get_template_directory_uri().'/img/favicon.png'; endif; ?>
<link rel="shortcut icon" type="image/jpg" href="<?php echo get_theme_mod('gr_favicon');?>"/>
<meta name="viewport" content="width=device-width, initial-scale=1.0"> 
